    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">All Device</strong>
            </div>
            <div class="card-body">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Variable Count</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>6</td>
                            <td>
                                <a href="{{route('admin.device.datatable',$device->id)}}" class="btn btn-info">Data Table</a>
                                <a href="{{route('admin.device.gpstable',$device->id)}}" class="btn btn-info">Gps Table</a>
                                <a href="{{route('admin.device.dashboard',$device->id)}}" class="btn btn-success">Dashboard</a>
                            </td>
                        </tr>
                        @endforeach
