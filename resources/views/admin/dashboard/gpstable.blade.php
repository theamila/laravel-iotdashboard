                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li>
                                <a href="#" class="active">GPS Data</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content mt-3">
            ...
            <div class="modal fade" id="deleteModal-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    ...
                    {{--  <form action="{{route('admin.data.destroy', $data->id)}}" style="display: none" id="deletedata-{{$data->id}}" method="POST">
                        @csrf
                        @method('DELETE')
                    </form>  --}}
                        </div>
